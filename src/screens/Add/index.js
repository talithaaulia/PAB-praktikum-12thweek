...
import {
  Box, FormControl, HStack, VStack,
  Modal, ModalBackdrop, ModalBody,
  FormControlLabel, Text, InputField,
  Input as GlueInput, Pressable,
  Heading, ModalHeader, ModalContent,
  ModalFooter, Alert, AlertIcon,
  AlertText, Center, ScrollView,
    ...
    <ScrollView>
      <Box flex={1} backgroundColor="$white">
        <Box shadowColor="$black" shadowOffset={{ width: 0, height: 2 }} 
             ...
             backgroundColor="$white" borderRadius={"$md"} mt={"$8"} 
             mx={"$3"} px={"$3"} pt={"$2"}
        >
        ...
        <Modal isOpen={isModalVisible} onClose={toggleModal} finalFocusRef={this.btnRef}>
          ...
          <ModalContent backgroundColor="$white" padding={"$2"} borderRadius={"$lg"}>
            ...
            <ModalBody>
              <GlueInput>
                <InputField role="form" placeholder="Category Name" value={newCategory} 
